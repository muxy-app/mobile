...
final class ProjectDetailViewModel {
    ...
    init(device: Device, project: Project, keychain: KeychainStore, connectionManager: ConnectionManager) {
        self.device = device
    ...
    private func loadWorkspace() async {
        ...
        do {
            ...
            Log.client.error("Failed to load workspace: \(error.localizedDescription, privacy: .public)")
        }
    }
